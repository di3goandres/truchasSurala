...
MetodoConteo             varchar(500) NOT NULL DEFAULT ,
NumeroConteoRealizado	 int(255) not null, 
...
insert into metodo_conteo (Nombre, Descripcion, created_at,updated_at,esOtro)
VALUES (
        'PALETA OVACONT',
        ...
        'VON BAYER',
         ...
         CURRENT_TIMESTAMP(), FALSE ),
          ...
          (
        'OTRO',
         'Por favor indicar cual es el método utilizado', 
         CURRENT_TIMESTAMP(),
